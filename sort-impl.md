<!--ts-->
   ...
   * [1. 冒泡排序](#1-冒泡排序)
      ...
      * [1.2 代码实现](#12-代码实现)
      * [1.3 算法分析](#13-算法分析)
      * [1.4 数字交换方法](#14-数字交换方法)
   * [2. 简单选择排序（Selection Sort）](#2-简单选择排序selection-sort)
      * [2.1 算法描述](#21-算法描述)
      * [2.2 代码实现](#22-代码实现)
      * [2.3 算法分析](#23-算法分析)
   * [3. 插入排序](#3-插入排序)
...
<!-- Added by: anapodoton, at: Mon Feb 17 17:59:29 CST 2020 -->
...
快速排序算法的改进：适用的情况，排序代码执行很多次或者被用在大型数组上（如果作为一个库函数，排序的对象数组的特性是未知的），下面的操作可以提高20%-30%的性能 。

1）切换到插入排序。因为小数组，快排比插入排序慢。

2）三取样切分。使用小数组的小部分元素的中位数来切分数组
